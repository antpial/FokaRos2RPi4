...
#include "msg_interfaces/msg/detail/sensor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_interfaces::msg::SensorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_interfaces::msg::SensorData & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces::msg::SensorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_interfaces::msg::SensorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_interfaces::msg::SensorData *>(
    untyped_ros_message);
...
{
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_interfaces, msg, SensorData)() {
  return &msg_interfaces::msg::typesupport_fastrtps_cpp::_SensorData__handle;
}
