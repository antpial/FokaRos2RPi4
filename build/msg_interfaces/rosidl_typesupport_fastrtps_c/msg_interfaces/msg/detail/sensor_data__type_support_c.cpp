...
#include "msg_interfaces/msg/detail/sensor_data__rosidl_typesupport_fastrtps_c.h"
...
using _SensorData__ros_msg_type = msg_interfaces__msg__SensorData;
...
static uint32_t _SensorData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msg_interfaces__msg__SensorData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_interfaces__msg__SensorData;
    is_plain =
      (
...
static size_t _SensorData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msg_interfaces__msg__SensorData(
