...
bool msg_interfaces__msg__sensor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_interfaces.msg._sensor_data.SensorData", full_classname_dest, 42) == 0);
  }
  msg_interfaces__msg__SensorData * ros_message = _ros_message;
  {  // temperature
...
PyObject * msg_interfaces__msg__sensor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_interfaces.msg._sensor_data");
