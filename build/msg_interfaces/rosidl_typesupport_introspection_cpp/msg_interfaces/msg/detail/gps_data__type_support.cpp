...
{
  new (message_memory) msg_interfaces::msg::GpsData(_init);
}

void GpsData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msg_interfaces::msg::GpsData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GpsData_message_member_array[5] = {
  {
    ...
    offsetof(msg_interfaces::msg::GpsData, latitude),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interfaces::msg::GpsData, longitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interfaces::msg::GpsData, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(msg_interfaces::msg::GpsData, satelites),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GpsData_message_members = {
  ...
  5,  // number of fields
  sizeof(msg_interfaces::msg::GpsData),
...
{
  return &::msg_interfaces::msg::rosidl_typesupport_introspection_cpp::GpsData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_interfaces, msg, GpsData)() {
  return &::msg_interfaces::msg::rosidl_typesupport_introspection_cpp::GpsData_message_type_support_handle;
}
